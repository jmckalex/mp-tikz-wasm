...
served from <https://jmckalex.org/software/mp-tikz-wasm/>:

- [Feature guide](https://jmckalex.org/software/mp-tikz-wasm/site/guide.html):
...
- [Editor demo](https://jmckalex.org/software/mp-tikz-wasm/site/index.html):
  galleries of MetaPost and TikZ examples with a live editor.
- [Drop-in tags](https://jmckalex.org/software/mp-tikz-wasm/site/tags.html): a
  page whose diagrams are just `<script type="text/tikz">` elements.
- [Real-time graphics](https://jmckalex.org/software/mp-tikz-wasm/site/live.html):
  six animations and interactive plots regenerated by MetaPost and LaTeX as
  you move the controls.
- [Two editors](https://jmckalex.org/software/mp-tikz-wasm/site/minimal.html):
  a MetaPost editor and a TikZ editor side by side with their output.
- [Single-file playground](https://jmckalex.org/software/mp-tikz-wasm/site/standalone.html):
